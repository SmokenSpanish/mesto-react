        ...
        >
            <fieldset className="popup__form">
                <label htmlFor="place-card" className="popup__label">
                    <input onChange={handleChange} type="text" className="popup__input_type_placeName popup__input" name="name"
                ...
                <label htmlFor="link-card" className="popup__label">
                    <input onChange={handleChange} type="url" className="popup__input_type_imgLink popup__input" name="link"
